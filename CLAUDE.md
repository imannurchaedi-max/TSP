...
This project is indexed by GitNexus as **TSP** (3088 symbols, 6495 relationships, 250 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
