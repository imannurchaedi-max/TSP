...
This project is indexed by GitNexus as **TSP** (3081 symbols, 6473 relationships, 249 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
