...
This project is indexed by GitNexus as **TSP** (3129 symbols, 6591 relationships, 252 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
