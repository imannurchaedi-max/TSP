...
This project is indexed by GitNexus as **TSP** (3178 symbols, 6383 relationships, 258 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
